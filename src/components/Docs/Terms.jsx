...
const Terms = props => (
  <div className="docs page-root terms" role="region">
    <div className="docs-container" role="document">
      ...
      <ol role="list" type="a">
        <li role="listitem">
          <span>
            ...
            materials (information or software) on Newsky&apos;s web site for
        ...
        <li role="listitem">
          ...
          restrictions and may be terminated by Newsky at any time. Upon
      ...
      <ol role="list" type="a">
        <li role="listitem">
          The materials on Newsky&apos;s web site are provided &quot;as
          is&quot;. Newsky makes no warranties, expressed or implied, and hereby
          disclaims and negates all other warranties, including without
          limitation, implied warranties or conditions of merchantability,
          fitness for a particular purpose, or non-infringement of intellectual
          property or other violation of rights. Further, Newsky does not
      ...
      <p>
        In no event shall Newsky or its suppliers be liable for any damages
        (including, without limitation, damages for loss of data or profit, or
        due to business interruption,) arising out of the use or inability to
        use the materials on Newsky&apos;s Internet site, even if Newsky or a
        Newsky authorized representative has been notified orally or in writing
      ...
      <p>
        The materials appearing on Newsky&apos;s web site could include
        technical, typographical, or photographic errors. Newsky does not
        warrant that any of the materials on its web site are accurate,
        complete, or current. Newsky may make changes to the materials contained
        on its web site at any time without notice. Newsky does not, however,
        make any commitment to update the materials.
      </p>
      <h3 role="heading">6. Links</h3>
      <p>
        Newsky has not reviewed all of the sites linked to its Internet web site
        and is not responsible for the contents of any such linked site. The
        inclusion of any link does not imply endorsement by Newsky of the site.
        Use of any such linked web site is at the user&apos;s own risk.
      </p>
      <h3 role="heading">7. Site Terms of Use Modifications</h3>
      <p>
        Newsky may revise these terms of use for its web site at any time
      ...
      <p>
        Any claim relating to Newsky&apos;s web site shall be governed by the
